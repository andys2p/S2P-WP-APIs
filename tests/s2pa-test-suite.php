...
if ( ! class_exists( 'WPPSTestSuite' ) ) {
	class WPPSTestSuite extends TestSuite {
		function __construct() {
			...
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-s2pa-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-s2pa-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-s2pa-instance-class.php' );
		}
